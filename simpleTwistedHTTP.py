#! /usr/bin/env python
"""
This program is a simple webserver built with Twisted
"""
...
class WebserverProtocol(basic.LineReceiver):
    ...
    def lineReceived(self, line):
        ...
        if line.startswith("GET"):
            # NOTE: I dont know how to catch and release this
            print "this line is firing inside GET"
            self._get_or_head(line)
            self.transport.write("this line is firing")


    def _get_or_head(self, request_string): #is this **kwargs?
        ...
        if (request_method == "GET") | (request_method == "HEAD"):
            ...
            file_requested = "/Users/antigen/dev/pythonNetworkProgrammingN00B/" + file_requested
